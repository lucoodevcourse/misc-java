...
/**
 * This example illustrates the Abstract Factory pattern. Creation knowledge is encapsulated, so the
 * client does not need to know the specific Expr classes to create an Expr instance.
 */
class SimpleExpressionsWithFactory {
  ...
  public static void main(String[] args) {
    ...
    Expr p =
        factory.div(
            factory.minus(
                factory.plus(factory.constant(1), factory.constant(2)),
                factory.times(factory.constant(3), factory.constant(4))),
            factory.constant(5));
