...
class Execute implements StatementVisitor<LValue> {
  ...
  public LValue visitMessage(Message t) {
    ...
    return ((Instance) mythis.get()).getMethod(t.getMethod()).execute(mythis, args).accept(this);
  }
...
public class Objects {
  ...
  */
  ...
  static final Clazz MyInt =
      new Clazz(
          new String[] {"value"},
          new Method[] {
            new Method("init") {
              public Statement execute(Variable mythis, Variable[] args) {
                      ...
                      new While(
                          ...
                          new Sequence(
                              new Statement[] {
                                ...
                                new Assignment(
                                    result, new Plus(result, new Selection(mythis, "value")))
                              })),
                      result
                    });
              }
                          ...
                          new Sequence(
                              new Statement[] {
                                ...
                                new Message(
                                    ...
                                    "init",
                                    new Statement[] {
                                      new Minus(new Selection(mythis, "value"), new Constant(1))
                                    }),
                                new Assignment(
                                    result,
                                    new Message(
                                        mythis,
                                        "times",
                                        new Statement[] {new Message(aux, "fact")}))
                              })),
                      result
                    });
              }
  ...
  public static void main(String[] arguments) {
    ...
    Clazz StudentCourseRecord =
        new Clazz(new String[] {"firstExamScore", "secondExamScore", "totalScore"});
    ...
    Statement p =
        new Sequence(
            new Statement[] {
              ...
              new Assignment(
                  new Selection(new Selection(r, "course1"), "firstExamScore"), new Constant(25)),
              new Assignment(
                  new Selection(new Selection(r, "course1"), "secondExamScore"), new Constant(35)),
              new Assignment(
                  new Selection(new Selection(r, "course1"), "totalScore"),
                  new Plus(
                      new Selection(new Selection(r, "course1"), "firstExamScore"),
